...
int main()
{
   ...
   {
       calculerResultats(unEtudiuantEtSesNote, totalMoyennes);

      canalSortie << setfill(MOTIF2) << left << setw(COL1) << unEtudiuantEtSesNote.etudiant << right << setw(COL2) << unEtudiuantEtSesNote.examen1 << setw(COL3) << unEtudiuantEtSesNote.examen2 << setw(COL4) << unEtudiuantEtSesNote.examenFinal;
