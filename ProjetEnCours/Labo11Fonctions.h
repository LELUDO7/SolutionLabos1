...
// Liste des bibliothèque qui seront utiliser dans tout les projet
#include <iostream>
...
// Listes des constantes qui seront vivisble partout dans les fonctions du project
const string NOM_FICHIER = "Donnees.txt";
const string RESULTAT = "Resultats.txt";
const string TITRE = "Résultats du cours d'object connectées";
...
// La liste eds structures : qui servent d'enveloppe pour regrouper plusieurs informations de type différent
struct info 
{
...
// Listes des prototypes des fonctions 
